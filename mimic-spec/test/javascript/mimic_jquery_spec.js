...
Screw.Unit(function() {
	describe('jquery', function() {
		...
		it('should fail to assert against selector', function() {
			...
			then.	it.should.say('Your specification did not pass!<br/><p>The selector "<b>.enqueued</b>" was expected but was not used!');
		});
		...
		it('should fail as the a selector was used when it was expected to not be used', function() {
			...
			then.	it.should.say('Your specification did not pass!<br/><p>The selector "<b>.enqueued</b>" was expected to never be used, however it was!');
		});
		...
		it('should fail as assertion is wrong', function() {
			...
			then.	it.should.say('Your specification did not pass!<br/><p>The function <b>show2()</b> was expected but did not get called!');
		});
		...
		it('should fail when allowing for multiple assertions in one should', function() {
			...
			then.	it.should.say('Your specification did not pass!<br/><p>The function <b>hide2()</b> was expected but did not get called!');
		});
		...
		it('should fail for an assertion of a function with a parameter', function() {
			...
			then.	it.should.say('Your specification did not pass!<br/><p>The function <b>show()</b> was expected to be called with <b>("speed")</b> but was called with <b>("sp33d")</b>');
		});
		...
		it('should fail for an assertion of a function with a parameter', function() {
			...
			then.	it.should.say('Your specification did not pass!<br/><p>The function <b>tabz()</b> was expected but did not get called!');
		});
		...
		it('should fail for an assertion of a function with a parameter', function() {
			...
			then.	it.should.say('Your specification did not pass!<br/><p>The function <b>attr()</b> was expected to be called with <b>({"key": "value"}, "theName", [1, 2, 3, "4"])</b> but was called with <b>({"k3y": "valu3"}, "theNam3", [1, 2, 3, "4"])</b>');
		});
