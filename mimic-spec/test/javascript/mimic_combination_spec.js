...
describe('combination', function() {
	...
	it('should not pass using a combination of number of occurrences and specifying parameters', function() {
		...
		alert(this);
		then.	it.should.say('Your specification did not pass!<br/><p>The specification expected <b>pan(3, "left")</b></p>');
	});
	...
	it('should not override any previous returns with a global return', function() {
		...
		then.	expect(map.pan(3, 'left')).toEqual(equal, 'first call');
		and.	expect(map.pan(2, 'right')).toEqual(equal, 'second call');
